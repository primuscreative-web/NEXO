...
| ---------------------- | -------------------------- | -------------------------------------------------------------- | --------------------- | --------------------------------------------------- | ------------------------------------ | -------------------------------------------------- |
| WhatsApp Cloud API     | Yes, Stitch                | Signed webhook, Graph adapter and Inbox processing implemented | Partial in Render     | Public callback responds; Meta subscription pending | No real message yet                  | Configuration incomplete                           |
...
- WhatsApp has a server-side verify token and a public callback at `https://www.agentenexo.com.br/api/webhooks/meta`. Phone registration, permanent system-user token, WABA subscription and real inbound/outbound tests remain pending.
